...
/**
 * A service to open modal windows. Creating a modal is straightforward: create
 * a template and pass it as an argument to the "open" method!
 */
@Injectable()
export class NgbModal {
   ...
   * options. Content can be provided as a TemplateRef or a component type. If
   * you pass a component type as content than instances of those components can
   * be injected with an instance of the NgbActiveModal class. You can use
   * methods on the NgbActiveModal class to close / dismiss modals from "inside"
   * of a component.
   */
